...
import ToggleButton from "../../ToggleButton"; // plasmic-import: rY4O6GgfEj50/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_copy_of_todo_mvc.module.css"; // plasmic-import: rtqeHxaDTf3jEdnrLWLsJW/projectcss
import sty from "./PlasmicFooter.module.css"; // plasmic-import: imXAZtdZyMod/css
  ...
  return (
    ...
    >
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__wwMaz, {
            [sty.freeBoxstate_empty__wwMazKtLGt]: hasVariant(
              $state,
              "state",
              "empty"
            ),
            [sty.freeBoxstate_hasCompleted__wwMazn1XbE]: hasVariant(
              $state,
              "state",
              "hasCompleted"
            ),
            [sty.freeBoxstate_singularLeft__wwMazF24C]: hasVariant(
              $state,
              "state",
              "singularLeft"
            )
          ...
          {(hasVariant($state, "state", "singularLeft") ? true : true) ? (
            <div
              className={classNames(
                ...
                sty.text__wNqMa,
                {
                  [sty.textstate_empty__wNqMaKtLGt]: hasVariant(
                    $state,
                    "state",
                    "empty"
                  ),
                  [sty.textstate_hasCompleted__wNqMan1XbE]: hasVariant(
                    $state,
                    "state",
                    "hasCompleted"
                  ),
                  [sty.textstate_singularLeft__wNqMaF24C]: hasVariant(
                    $state,
                    "state",
                    "singularLeft"
                  )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mJ5L)}
      >
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__d85Wu)}
          state={"selected" as const}
        >
          {"All"}
        </ToggleButton>
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__hpGfm)}
        >
          {"Completed"}
        </ToggleButton>
        <ToggleButton
          className={classNames("__wab_instance", sty.toggleButton__eRz6K)}
        >
          {"Active"}
        </ToggleButton>
      </p.Stack>
      {(hasVariant($state, "state", "hasCompleted") ? true : false) ? (
        <div
          className={classNames(
            ...
            sty.text__eQItc,
            {
              [sty.textstate_hasCompleted__eQItcN1XbE]: hasVariant(
                $state,
                "state",
                "hasCompleted"
              )
